  ...
  const features = [
    {
      ...
      title: "Post Your Books",
      description: "List the books you own and want to swap, along with those you're looking for."
    },
    {
      icon: <Search className="h-10 w-10 text-bookswap-accent" />,
      title: "Find Books You Want",
      description: "Browse through available books from other users and filter by genre or condition."
    },
    {
      icon: <MessageSquare className="h-10 w-10 text-bookswap-accent" />,
      title: "Connect & Swap",
      description: "Get notified when there's a match and arrange the swap through our messaging system."
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold leading-tight text-bookswap-darkbrown mb-6 animate-fade-up" style={{ animationDelay: '300ms' }}>
                Swap <span className="text-bookswap-secondary">Books</span>, 
                <br />Share <span className="text-bookswap-accent">Stories</span>
              </h1>
              <p className="text-bookswap-brown text-lg mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-up" style={{ animationDelay: '400ms' }}>
                BookSwap connects book lovers to exchange their favorite reads. 
                Find new stories while giving your books a new home.
              </p>
            ...
            <div className="lg:w-1/2 flex items-center justify-center animate-fade-up" style={{ animationDelay: '600ms' }}>
              <div className="relative w-full max-w-lg h-72 sm:h-96">
                <div className="absolute top-0 -right-4 sm:right-0 w-48 h-64 sm:w-60 sm:h-80 bg-white rounded-lg shadow-lg transform rotate-3 z-10">
                  <img 
                ...
                <div className="absolute top-10 right-12 sm:right-16 w-48 h-64 sm:w-60 sm:h-80 bg-white rounded-lg shadow-lg transform -rotate-6 z-20">
                  <img 
                ...
                <div className="absolute top-20 right-28 sm:right-32 w-48 h-64 sm:w-60 sm:h-80 bg-white rounded-lg shadow-lg transform rotate-6 z-30">
                  <img 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-bookswap-brown text-lg max-w-3xl mx-auto">
              Our platform makes exchanging books simple and enjoyable. Follow these steps to start swapping.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between mb-10">
            <div>
              ...
              <p className="text-bookswap-brown text-lg">
                Discover what other readers are sharing
              </p>
            </div>
            <Link to="/browse">
              <Button 
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-10 lg:gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-white/90 mb-8">
                BookSwap is more than just exchanging books—it's about creating connections through shared stories. 
                Join our community of passionate readers and discover new favorites while giving your books a second life.
              </p>
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4 max-w-lg">
              ...
              <div className="bg-white/10 p-6 rounded-lg">
                ...
                <p className="text-white/80">Successful Swaps</p>
              </div>
              <div className="bg-white/10 p-6 rounded-lg">
